...
If a Claude adviser fails or the Codex council comes back degraded or failed, say so plainly and label the result as a partial council; never silently present fewer advisers as the full council.
